...
public class MusicDML {
    ...
    private static boolean executeSelect(Statement statement, String table, String columnName, String columnValue) throws SQLException {
        String query = "SELECT * FROM %s WHERE %s='%s'".formatted(
    ...
    public static boolean deleteRecord(Statement statement, String table, String columnName, String columnValue) throws SQLException {
    ...
    public static boolean updateRecord(Statement statement, String table, String matchedCol, String matchedVal, String updatedCol, String updatedVal) throws SQLException {
        String query = "UPDATE %s SET %s='%s' WHERE %s='%s'"
                .formatted(table, updatedCol, updatedVal, matchedCol, matchedVal);
        System.out.println(query);
        statement.execute(query);
        int recordsUpdated = statement.getUpdateCount();
        if(recordsUpdated > 0) {
            executeSelect(statement, table, updatedCol, updatedVal);
        }
        return recordsUpdated > 0;
    }

    public static void insertArtistAlbum(Statement statement,
                                         String artistName,
                                         String albumName)
        throws SQLException {
